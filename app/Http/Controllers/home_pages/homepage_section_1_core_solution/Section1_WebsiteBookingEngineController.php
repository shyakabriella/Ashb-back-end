...
use App\Models\home_pages\homepage_section_1_core_solution\Section1_WebsiteBookingEngine;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class Section1_WebsiteBookingEngineController extends Controller
{
    public function index()
    {
        $data = Section1_WebsiteBookingEngine::all();
    ...
    {
        $data = Section1_WebsiteBookingEngine::findOrFail($id);
        return response()->json([
            'success' => true,
            'data' => $data
        ]);
    ...
    public function store(Request $request)
    {
        ...
        $data = Section1_WebsiteBookingEngine::create([
