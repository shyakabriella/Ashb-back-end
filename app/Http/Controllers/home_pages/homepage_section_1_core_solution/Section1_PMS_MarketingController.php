...
use App\Models\home_pages\homepage_section_1_core_solution\Section1_PMS_Marketing;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class Section1_PMS_MarketingController extends Controller
{
    public function index()
    {
        $data = Section1_PMS_Marketing::all();
    ...
    {
        $data = Section1_PMS_Marketing::findOrFail($id);
        return response()->json([
            'success' => true,
            'data' => $data
        ]);
    ...
    public function store(Request $request)
    {
        ...
        $data = Section1_PMS_Marketing::create([
