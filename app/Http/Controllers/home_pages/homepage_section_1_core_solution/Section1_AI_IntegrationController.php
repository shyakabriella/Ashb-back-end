...
use App\Models\home_pages\homepage_section_1_core_solution\Section1_AI_Integration;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class Section1_AI_IntegrationController extends Controller
{
    public function index()
    {
        $data = Section1_AI_Integration::all();
    ...
    {
        $data = Section1_AI_Integration::findOrFail($id);
        return response()->json([
            'success' => true,
            'data' => $data
        ]);
    ...
    public function store(Request $request)
    {
        ...
        $data = Section1_AI_Integration::create([
