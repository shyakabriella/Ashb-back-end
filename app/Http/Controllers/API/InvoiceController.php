...
class InvoiceController extends BaseController
{
     ...
     *
     * The submitted amount/property price is the final amount
     * payable. VAT is deducted from this amount for the
     * invoice breakdown.
     */
    public function pushPropertyInvoice(
        ...
        /*
         * The provided amount is the final amount payable.
         * VAT is deducted from it for the invoice breakdown.
         */
        $invoiceAmount = array_key_exists('amount', $data)
            ? (float) $data['amount']
            : (float) ($property->price ?? 0);

        $pricing = $this->calculateVat($invoiceAmount);
        ...
        $invoice->forceFill([
            ...
            /*
             * invoice.amount stores the entered final amount.
             * VAT is not added again to the payable amount.
             */
    ...
    /**
     * Deduct VAT from the entered final invoice amount.
     *
     * Example:
     * Total amount: 5,000
     * VAT: 900
    ...
    /**
     * Prepare an invoice for API responses.
     */
    private function transformInvoice(
        ...
        $data['amount_includes_vat'] = (bool) (
            $metadata['amount_includes_vat']
            ?? false
        );
